document.addEventListener('DOMContentLoaded', ()=>{
    async function getData(){
        ...
        let {products} = data;
        products.map((items)=>{
            let cardCont = document.getElementById('card');
            let {title, description, availibilityStatus, category, warrantyInformation, price, rating, thumbnail, brand, id } = items;
            cardCont.innerHTML += `<a href="Product-Details/Product.html?id=${id}"  style="text-decoration:none;"><div class="product-card">
            <div class="product-badge">Premium</div>
            <div class="product-tilt-effect">
                <div class="product-image">
                    <img src="${thumbnail}" alt="Premium Watch">
                </div>
            </div>
            <div class="product-info">
                ...
                <div class="product-meta">
                    ...
                    <div class="product-stock">${availibilityStatus}</div>
                </div>
            </div>
        </div></a>`
        })
